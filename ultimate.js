...
// basically creating all elements + adding id's
    ...
    btn5.onclick = () => {
     ...
     setInterval(load(), 15000);
      ...
      console23.id = "console23"
      console233.id = "console233"
...
#btn1, #btn2, #btn3, #btn4, #btn5, #consolebtn {
  background-color: grey;
  color: white;
  font-family: "Open Sans";
  width: 50% !important;
...
#btn2:hover,#btn1:hover, #btn3:hover, #btn4:hover, #btn5:hover, #consolebtn:hover {
  background-color: white;
  color: black;
  font-family: "Open Sans";
  width: 55% !important;
